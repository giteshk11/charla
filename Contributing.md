# How to contribute to Chat App Embed? Beginners are very welcome!
...
1. This project uses **Vue.js, Node.js, socket.io**. So, although it is not required for you to already have experience with this stack, its going to more comfort to.
...
```bash
$ git remote add upstream https://github.com/giteshk11/chat-app-frontend.git
```
